    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            if(accion != null && "Guardar".equals(accion) )
            {
                ...
                out.println("<center><div class=\"card\" style=\"width: 24rem;\">\n" +
"  <div class=\"card-body\">\n" +
"    <h5 class=\"card-title\">Exito!!!</h5>\n" +
"    <p class=\"card-text\">Usted acaba de agregar un usuario, presione el boton de abajo para regresar.</p>\n" +
"    <a href=\"ClienteList\" class=\"btn btn-outline-info\">Ver tabla de clientes</a>\n" +
"  </div>\n" +
"</div></center>");
                out.println("<title> Pilin </title>");
            }
            else
            {
